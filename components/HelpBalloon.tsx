...
import { CircleHelp as HelpCircle, X, Mail, Video, MessageCircle, ChevronRight, Headphones, TriangleAlert as AlertTriangle, RotateCcw } from 'lucide-react-native'stants/theme';
import Animated, { 
  useSharedValue, 
  useAnimatedStyle, 
  withSpring,
